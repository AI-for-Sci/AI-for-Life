...
from hiagi.transformers import (  # UniSpeechSatCTCTokenizer,; UniSpeechSatFeatureExtractor,; UniSpeechSatProcessor,
    UniSpeechSatConfig,
    UniSpeechSatForCTC,
...
def convert_unispeech_sat_checkpoint(
    ...
    model, _, _ = fairseq.checkpoint_utils.load_model_ensemble_and_task(
        [checkpoint_path], arg_overrides={"preprocess": "/".join(dict_path.split("/")[:-1])}
    )
    model = model[0].eval()
