...
from hiagi.transformers.file_utils import ModelOutput, is_tf_available, is_torch_available
from hiagi.transformers.pipelines import Pipeline, pipeline
from hiagi.transformers.tokenization_utils import BatchEncoding
...
def ensure_valid_input(model, tokens, input_names):
    ...
    Args:
        model: The model used to forward the input preprocess
        tokens: BatchEncoding holding the input preprocess
