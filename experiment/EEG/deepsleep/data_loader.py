...
class NonSeqDataLoader(object):
    ...
    def _load_cv_data(self, list_files):
        ...
        data_train, label_train, fs_train = self._load_npz_list_files(train_files)
        print(" ")
        print("Load validation set:")
        data_val, label_val, fs_val = self._load_npz_list_files(val_files[self.fold_idx])
        print(" ")
        ...
        return data_train, label_train, data_val, label_val, fs_train, fs_val
    ...
    def load_train_data(self, n_files=None):
        ...
        print("Load training set:")
        data_train, label_train, fs_train = self._load_npz_list_files(npz_files=train_files)
        print(" ")
        print("Load validation set:")
        data_val, label_val, fs_val = self._load_npz_list_files(npz_files=subject_files)
        print(" ")
