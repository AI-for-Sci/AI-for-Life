...
def encoder(input_encoder, num_classes=5):
    ...
    # Dense块 Block 1
    x = layers.Dense(units=128)(inputs)
...
if __name__ == "__main__":
    ...
    # 初始化编码器和解码器
    num_classes = 5
    model = encoder(input_encoder=(3000), num_classes=num_classes)
    # 显示模型结构
    model.summary()
    ...
    # Precision: [0.5539 0.2492 0.8938 0.5872 0.3743]
    # Recall: [0.5799 0.408  0.6129 0.6866 0.5983]
    # F1: [0.5666 0.3094 0.7272 0.633  0.4605]
