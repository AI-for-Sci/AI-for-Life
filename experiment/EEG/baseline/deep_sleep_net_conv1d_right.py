...
def encoder(input_encoder, num_classes=5):
    ...
    # Conv1d块 Block 1
    x = layers.Conv1D(filters=64, kernel_size=400, strides=50, padding='same')(inputs)
...
if __name__ == "__main__":
    ...
    # Precision: [0.9069 0.2884 0.9866 0.6781 0.5381]
    # Recall: [0.8245 0.4577 0.6645 0.9851 0.8786]
    # F1: [0.8637 0.3538 0.7941 0.8032 0.6674]
    # Overall accuracy: 0.7291
    # Macro - F1 accuracy: 0.6965
